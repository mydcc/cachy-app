...
📊 Impact
- **Unmeasured but reasoned:** Avoids multiple array allocations per frame or component update when `news` or unrelated state updates. It guarantees Svelte tracks the iteration over a stable reference.
