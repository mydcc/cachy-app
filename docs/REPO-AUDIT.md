...
**565 warnings remain**, dominated by `no-explicit-any` (456) and
`no-unused-vars` (109). CI enforces `--max-warnings 565` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 565 warnings under the CI ratchet |
