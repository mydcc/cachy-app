...
**89 warnings remain**, dominated by `no-explicit-any` (63) and
`no-unused-vars` (26). CI enforces `--max-warnings 89` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 89 warnings under the CI ratchet |
