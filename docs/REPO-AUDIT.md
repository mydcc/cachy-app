...
**585 warnings remain**, dominated by `no-explicit-any` (469) and
`no-unused-vars` (116). CI enforces `--max-warnings 585` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 585 warnings under the CI ratchet |
