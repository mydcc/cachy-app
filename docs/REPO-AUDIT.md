...
**417 warnings remain**, dominated by `no-explicit-any` (332) and
`no-unused-vars` (85). CI enforces `--max-warnings 417` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 417 warnings under the CI ratchet |
