...
**382 warnings remain**, dominated by `no-explicit-any` (302) and
`no-unused-vars` (80). CI enforces `--max-warnings 382` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 382 warnings under the CI ratchet |
