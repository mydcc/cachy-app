...
**549 warnings remain**, dominated by `no-explicit-any` (442) and
`no-unused-vars` (107). CI enforces `--max-warnings 549` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 549 warnings under the CI ratchet |
