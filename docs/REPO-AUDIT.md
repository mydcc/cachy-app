...
**402 warnings remain**, dominated by `no-explicit-any` (320) and
`no-unused-vars` (82). CI enforces `--max-warnings 402` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 402 warnings under the CI ratchet |
