...
**354 warnings remain**, dominated by `no-explicit-any` (274) and
`no-unused-vars` (80). CI enforces `--max-warnings 354` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 354 warnings under the CI ratchet |
