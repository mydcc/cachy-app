...
**601 warnings remain**, dominated by `no-explicit-any` (485) and
`no-unused-vars` (116). CI enforces `--max-warnings 601` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 601 warnings under the CI ratchet |
