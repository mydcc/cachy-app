...
**59 warnings remain**, dominated by `no-explicit-any` (40) and
`no-unused-vars` (19). CI enforces `--max-warnings 59` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 59 warnings under the CI ratchet |
