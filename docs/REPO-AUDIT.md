...
**460 warnings remain**, dominated by `no-explicit-any` (373) and
`no-unused-vars` (87). CI enforces `--max-warnings 460` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 460 warnings under the CI ratchet |
