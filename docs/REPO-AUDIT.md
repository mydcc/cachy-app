...
**425 warnings remain**, dominated by `no-explicit-any` (340) and
`no-unused-vars` (85). CI enforces `--max-warnings 425` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 425 warnings under the CI ratchet |
