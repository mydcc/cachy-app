...
**370 warnings remain**, dominated by `no-explicit-any` (290) and
`no-unused-vars` (80). CI enforces `--max-warnings 370` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 370 warnings under the CI ratchet |
