...
**229 warnings remain**, dominated by `no-explicit-any` (167) and
`no-unused-vars` (62). CI enforces `--max-warnings 229` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 229 warnings under the CI ratchet |
