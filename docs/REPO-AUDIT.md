...
**74 warnings remain**, dominated by `no-explicit-any` (51) and
`no-unused-vars` (23). CI enforces `--max-warnings 74` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 74 warnings under the CI ratchet |
