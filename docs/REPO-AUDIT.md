...
**143 warnings remain**, dominated by `no-explicit-any` (105) and
`no-unused-vars` (38). CI enforces `--max-warnings 143` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 143 warnings under the CI ratchet |
