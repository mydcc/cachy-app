...
**531 warnings remain**, dominated by `no-explicit-any` (427) and
`no-unused-vars` (104). CI enforces `--max-warnings 531` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 531 warnings under the CI ratchet |
