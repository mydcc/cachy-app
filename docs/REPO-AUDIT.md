...
**557 warnings remain**, dominated by `no-explicit-any` (449) and
`no-unused-vars` (108). CI enforces `--max-warnings 557` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 557 warnings under the CI ratchet |
