...
**173 warnings remain**, dominated by `no-explicit-any` (134) and
`no-unused-vars` (39). CI enforces `--max-warnings 173` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 173 warnings under the CI ratchet |
