...
**534 warnings remain**, dominated by `no-explicit-any` (430) and
`no-unused-vars` (104). CI enforces `--max-warnings 534` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 534 warnings under the CI ratchet |
