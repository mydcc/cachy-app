...
**395 warnings remain**, dominated by `no-explicit-any` (313) and
`no-unused-vars` (82). CI enforces `--max-warnings 395` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 395 warnings under the CI ratchet |
