...
**546 warnings remain**, dominated by `no-explicit-any` (439) and
`no-unused-vars` (107). CI enforces `--max-warnings 546` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 546 warnings under the CI ratchet |
