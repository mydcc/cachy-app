...
**256 warnings remain**, dominated by `no-explicit-any` (189) and
`no-unused-vars` (67). CI enforces `--max-warnings 256` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 256 warnings under the CI ratchet |
