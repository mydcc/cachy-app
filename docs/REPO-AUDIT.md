...
**501 warnings remain**, dominated by `no-explicit-any` (407) and
`no-unused-vars` (94). CI enforces `--max-warnings 501` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 501 warnings under the CI ratchet |
