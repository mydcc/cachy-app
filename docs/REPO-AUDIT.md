...
**203 warnings remain**, dominated by `no-explicit-any` (151) and
`no-unused-vars` (52). CI enforces `--max-warnings 203` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 203 warnings under the CI ratchet |
