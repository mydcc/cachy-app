...
**504 warnings remain**, dominated by `no-explicit-any` (410) and
`no-unused-vars` (94). CI enforces `--max-warnings 504` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 504 warnings under the CI ratchet |
