...
**561 warnings remain**, dominated by `no-explicit-any` (453) and
`no-unused-vars` (108). CI enforces `--max-warnings 561` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 561 warnings under the CI ratchet |
