...
**597 warnings remain**, dominated by `no-explicit-any` (481) and
`no-unused-vars` (116). CI enforces `--max-warnings 597` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 597 warnings under the CI ratchet |
