...
**537 warnings remain**, dominated by `no-explicit-any` (433) and
`no-unused-vars` (104). CI enforces `--max-warnings 537` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 537 warnings under the CI ratchet |
