...
**577 warnings remain**, dominated by `no-explicit-any` (464) and
`no-unused-vars` (113). CI enforces `--max-warnings 577` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 577 warnings under the CI ratchet |
