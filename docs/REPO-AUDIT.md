...
**490 warnings remain**, dominated by `no-explicit-any` (399) and
`no-unused-vars` (91). CI enforces `--max-warnings 490` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 490 warnings under the CI ratchet |
