...
**349 warnings remain**, dominated by `no-explicit-any` (269) and
`no-unused-vars` (80). CI enforces `--max-warnings 349` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 349 warnings under the CI ratchet |
