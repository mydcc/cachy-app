...
**301 warnings remain**, dominated by `no-explicit-any` (226) and
`no-unused-vars` (75). CI enforces `--max-warnings 301` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 301 warnings under the CI ratchet |
