...
**223 warnings remain**, dominated by `no-explicit-any` (164) and
`no-unused-vars` (59). CI enforces `--max-warnings 223` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 223 warnings under the CI ratchet |
