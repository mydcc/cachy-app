...
**540 warnings remain**, dominated by `no-explicit-any` (433) and
`no-unused-vars` (107). CI enforces `--max-warnings 540` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 540 warnings under the CI ratchet |
