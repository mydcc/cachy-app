...
**364 warnings remain**, dominated by `no-explicit-any` (284) and
`no-unused-vars` (80). CI enforces `--max-warnings 364` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 364 warnings under the CI ratchet |
