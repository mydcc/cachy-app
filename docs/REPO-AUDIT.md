...
**433 warnings remain**, dominated by `no-explicit-any` (348) and
`no-unused-vars` (85). CI enforces `--max-warnings 433` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 433 warnings under the CI ratchet |
