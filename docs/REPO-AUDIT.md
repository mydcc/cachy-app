...
**376 warnings remain**, dominated by `no-explicit-any` (296) and
`no-unused-vars` (80). CI enforces `--max-warnings 376` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 376 warnings under the CI ratchet |
