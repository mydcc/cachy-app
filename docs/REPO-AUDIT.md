...
**543 warnings remain**, dominated by `no-explicit-any` (436) and
`no-unused-vars` (107). CI enforces `--max-warnings 543` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 543 warnings under the CI ratchet |
