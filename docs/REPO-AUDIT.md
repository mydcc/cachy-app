...
**113 warnings remain**, dominated by `no-explicit-any` (80) and
`no-unused-vars` (33). CI enforces `--max-warnings 113` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 113 warnings under the CI ratchet |
