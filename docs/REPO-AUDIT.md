...
**359 warnings remain**, dominated by `no-explicit-any` (279) and
`no-unused-vars` (80). CI enforces `--max-warnings 359` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 359 warnings under the CI ratchet |
