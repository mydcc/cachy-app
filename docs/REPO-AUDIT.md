...
**388 warnings remain**, dominated by `no-explicit-any` (307) and
`no-unused-vars` (81). CI enforces `--max-warnings 388` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 388 warnings under the CI ratchet |
