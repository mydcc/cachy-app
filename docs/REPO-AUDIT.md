...
**289 warnings remain**, dominated by `no-explicit-any` (215) and
`no-unused-vars` (74). CI enforces `--max-warnings 289` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 289 warnings under the CI ratchet |
