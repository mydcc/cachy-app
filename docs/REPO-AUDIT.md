...
**507 warnings remain**, dominated by `no-explicit-any` (412) and
`no-unused-vars` (95). CI enforces `--max-warnings 507` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 507 warnings under the CI ratchet |
