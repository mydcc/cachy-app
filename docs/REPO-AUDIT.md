...
**519 warnings remain**, dominated by `no-explicit-any` (424) and
`no-unused-vars` (95). CI enforces `--max-warnings 519` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 519 warnings under the CI ratchet |
