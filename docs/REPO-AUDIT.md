...
**569 warnings remain**, dominated by `no-explicit-any` (460) and
`no-unused-vars` (109). CI enforces `--max-warnings 569` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 569 warnings under the CI ratchet |
