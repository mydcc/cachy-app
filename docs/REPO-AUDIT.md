...
**589 warnings remain**, dominated by `no-explicit-any` (473) and
`no-unused-vars` (116). CI enforces `--max-warnings 589` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 589 warnings under the CI ratchet |
