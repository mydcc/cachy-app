...
**442 warnings remain**, dominated by `no-explicit-any` (355) and
`no-unused-vars` (87). CI enforces `--max-warnings 442` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 442 warnings under the CI ratchet |
