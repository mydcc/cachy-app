...
**44 warnings remain**, dominated by `no-explicit-any` (30) and
`no-unused-vars` (14). CI enforces `--max-warnings 44` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 44 warnings under the CI ratchet |
