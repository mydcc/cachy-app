...
**510 warnings remain**, dominated by `no-explicit-any` (415) and
`no-unused-vars` (95). CI enforces `--max-warnings 510` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 510 warnings under the CI ratchet |
