...
**593 warnings remain**, dominated by `no-explicit-any` (477) and
`no-unused-vars` (116). CI enforces `--max-warnings 593` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 593 warnings under the CI ratchet |
