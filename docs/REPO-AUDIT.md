...
**451 warnings remain**, dominated by `no-explicit-any` (364) and
`no-unused-vars` (87). CI enforces `--max-warnings 451` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 451 warnings under the CI ratchet |
