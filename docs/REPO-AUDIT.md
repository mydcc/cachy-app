...
**333 warnings remain**, dominated by `no-explicit-any` (255) and
`no-unused-vars` (78). CI enforces `--max-warnings 333` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 333 warnings under the CI ratchet |
