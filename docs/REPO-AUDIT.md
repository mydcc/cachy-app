...
**409 warnings remain**, dominated by `no-explicit-any` (327) and
`no-unused-vars` (82). CI enforces `--max-warnings 409` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 409 warnings under the CI ratchet |
