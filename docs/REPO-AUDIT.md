...
**513 warnings remain**, dominated by `no-explicit-any` (418) and
`no-unused-vars` (95). CI enforces `--max-warnings 513` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 513 warnings under the CI ratchet |
