...
**516 warnings remain**, dominated by `no-explicit-any` (421) and
`no-unused-vars` (95). CI enforces `--max-warnings 516` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 516 warnings under the CI ratchet |
