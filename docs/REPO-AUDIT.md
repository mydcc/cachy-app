...
**528 warnings remain**, dominated by `no-explicit-any` (426) and
`no-unused-vars` (102). CI enforces `--max-warnings 528` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 528 warnings under the CI ratchet |
