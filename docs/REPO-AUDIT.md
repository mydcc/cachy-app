...
**553 warnings remain**, dominated by `no-explicit-any` (445) and
`no-unused-vars` (108). CI enforces `--max-warnings 553` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 553 warnings under the CI ratchet |
