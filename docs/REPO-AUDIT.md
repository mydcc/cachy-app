...
**581 warnings remain**, dominated by `no-explicit-any` (465) and
`no-unused-vars` (116). CI enforces `--max-warnings 581` as a ratchet: the
...
| `npx eslint .` | **0 errors**, 581 warnings under the CI ratchet |
