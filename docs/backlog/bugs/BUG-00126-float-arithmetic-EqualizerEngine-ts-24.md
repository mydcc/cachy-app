---
id: BUG-00126
title: Native float arithmetic used for financial values in EqualizerEngine.ts:24
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00126 — Native float arithmetic used for financial values in EqualizerEngine.ts:24
