---
id: BUG-00131
title: Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:131
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00131 — Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:131
