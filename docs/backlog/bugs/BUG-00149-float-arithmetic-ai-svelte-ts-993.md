---
id: BUG-00149
title: Native float arithmetic used for financial values in ai.svelte.ts:993
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00149 — Native float arithmetic used for financial values in ai.svelte.ts:993
