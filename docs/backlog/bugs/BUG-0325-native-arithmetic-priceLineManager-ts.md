...
# BUG-0325 — Native arithmetic usage found in src/services/chart/priceLineManager.ts
...
- **Location**: `src/services/chart/priceLineManager.ts:364`
...
Replace the identified usage of native arithmetic at `src/services/chart/priceLineManager.ts:364` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/chart/priceLineManager.ts:364` is replaced with safe decimal arithmetic
