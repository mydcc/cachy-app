---
id: BUG-0396
title: Native arithmetic usage found in src/lib/calculators/stats.ts
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0396 — Native arithmetic usage found in src/lib/calculators/stats.ts
...
- **Location**: `src/lib/calculators/stats.ts:471`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/stats.ts:471` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/stats.ts:471` is replaced with safe decimal arithmetic
