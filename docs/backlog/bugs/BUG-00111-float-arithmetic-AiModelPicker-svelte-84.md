---
id: BUG-00111
title: Native float arithmetic used for financial values in AiModelPicker.svelte:84
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00111 — Native float arithmetic used for financial values in AiModelPicker.svelte:84
...
File: `src/components/settings/AiModelPicker.svelte`
Line: 84
