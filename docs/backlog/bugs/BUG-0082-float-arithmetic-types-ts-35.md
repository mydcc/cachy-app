---
id: BUG-0082
title: Native float arithmetic used for financial values in types.ts:35
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0082 — Native float arithmetic used for financial values in types.ts:35
...
File: `src/services/smc/types.ts`
Line: 35
