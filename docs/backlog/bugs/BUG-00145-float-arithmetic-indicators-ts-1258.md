---
id: BUG-00145
title: Native float arithmetic used for financial values in indicators.ts:1258
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00145 — Native float arithmetic used for financial values in indicators.ts:1258
