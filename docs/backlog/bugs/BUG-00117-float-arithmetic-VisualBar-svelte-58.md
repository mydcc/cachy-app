---
id: BUG-00117
title: Native float arithmetic used for financial values in VisualBar.svelte:58
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00117 — Native float arithmetic used for financial values in VisualBar.svelte:58
...
File: `src/components/shared/VisualBar.svelte`
Line: 58
