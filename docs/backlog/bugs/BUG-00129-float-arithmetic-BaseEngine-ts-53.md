---
id: BUG-00129
title: Native float arithmetic used for financial values in BaseEngine.ts:53
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00129 — Native float arithmetic used for financial values in BaseEngine.ts:53
...
File: `src/components/shared/backgrounds/engines/BaseEngine.ts`
Line: 53
