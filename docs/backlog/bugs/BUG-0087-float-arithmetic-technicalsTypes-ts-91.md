---
id: BUG-0087
title: Native float arithmetic used for financial values in technicalsTypes.ts:91
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0087 — Native float arithmetic used for financial values in technicalsTypes.ts:91
