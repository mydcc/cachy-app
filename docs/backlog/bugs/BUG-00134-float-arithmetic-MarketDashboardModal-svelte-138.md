---
id: BUG-00134
title: Native float arithmetic used for financial values in MarketDashboardModal.svelte:138
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00134 — Native float arithmetic used for financial values in MarketDashboardModal.svelte:138
