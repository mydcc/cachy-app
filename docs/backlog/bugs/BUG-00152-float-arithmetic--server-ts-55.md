---
id: BUG-00152
title: Native float arithmetic used for financial values in +server.ts:55
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00152 — Native float arithmetic used for financial values in +server.ts:55
...
File: `src/routes/api/ai/openrouter/models/+server.ts`
Line: 55
