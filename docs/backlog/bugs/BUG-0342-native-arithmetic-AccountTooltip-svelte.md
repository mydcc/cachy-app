...
# BUG-0342 — Native arithmetic usage found in src/components/shared/AccountTooltip.svelte
...
- **Location**: `src/components/shared/AccountTooltip.svelte:98`
...
Replace the identified usage of native arithmetic at `src/components/shared/AccountTooltip.svelte:98` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/AccountTooltip.svelte:98` is replaced with safe decimal arithmetic
