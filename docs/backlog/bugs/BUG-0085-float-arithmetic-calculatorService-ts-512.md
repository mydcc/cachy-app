---
id: BUG-0085
title: Native float arithmetic used for financial values in calculatorService.ts:512
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0085 — Native float arithmetic used for financial values in calculatorService.ts:512
