---
id: BUG-00146
title: Native float arithmetic used for financial values in divergenceScanner.ts:36
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00146 — Native float arithmetic used for financial values in divergenceScanner.ts:36
...
File: `src/utils/divergenceScanner.ts`
Line: 36
