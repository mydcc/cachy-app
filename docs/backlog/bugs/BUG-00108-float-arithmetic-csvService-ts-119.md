---
id: BUG-00108
title: Native float arithmetic used for financial values in csvService.ts:119
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00108 — Native float arithmetic used for financial values in csvService.ts:119
