---
id: BUG-0088
title: Native float arithmetic used for financial values in technicalsTypes.ts:104
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0088 — Native float arithmetic used for financial values in technicalsTypes.ts:104
