...
# BUG-0379 — Native arithmetic usage found in src/lib/calculators/charts.ts
...
- **Location**: `src/lib/calculators/charts.ts:384`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/charts.ts:384` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/charts.ts:384` is replaced with safe decimal arithmetic
