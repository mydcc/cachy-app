---
id: BUG-00164
title: Native float arithmetic used for financial values in SymbolPickerView.svelte:107
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00164 — Native float arithmetic used for financial values in SymbolPickerView.svelte:107
