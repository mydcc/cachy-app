...
# BUG-0355 — Native arithmetic usage found in src/components/shared/backgrounds/TradeFlowBackground.svelte
...
- **Location**: `src/components/shared/backgrounds/TradeFlowBackground.svelte:147`
...
Replace the identified usage of native arithmetic at `src/components/shared/backgrounds/TradeFlowBackground.svelte:147` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/backgrounds/TradeFlowBackground.svelte:147` is replaced with safe decimal arithmetic
