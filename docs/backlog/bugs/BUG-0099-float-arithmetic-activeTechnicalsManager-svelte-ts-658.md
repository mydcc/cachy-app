---
id: BUG-0099
title: Native float arithmetic used for financial values in activeTechnicalsManager.svelte.ts:658
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0099 — Native float arithmetic used for financial values in activeTechnicalsManager.svelte.ts:658
