---
id: BUG-00140
title: Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:315
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00140 — Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:315
