---
id: BUG-0095
title: Native float arithmetic used for financial values in uiManager.ts:72
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0095 — Native float arithmetic used for financial values in uiManager.ts:72
