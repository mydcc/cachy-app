---
id: BUG-00166
title: Native float arithmetic used for financial values in SymbolPickerView.svelte:120
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00166 — Native float arithmetic used for financial values in SymbolPickerView.svelte:120
