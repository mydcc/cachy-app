...
# BUG-0389 — Native arithmetic usage found in src/lib/calculators/charts.ts
...
- **Location**: `src/lib/calculators/charts.ts:731`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/charts.ts:731` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/charts.ts:731` is replaced with safe decimal arithmetic
