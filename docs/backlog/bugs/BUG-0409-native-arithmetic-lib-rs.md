...
# BUG-0409 — Native arithmetic usage found in technicals-wasm/src/lib.rs
...
- **Location**: `technicals-wasm/src/lib.rs:682`
...
Replace the identified usage of native arithmetic at `technicals-wasm/src/lib.rs:682` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `technicals-wasm/src/lib.rs:682` is replaced with safe decimal arithmetic
