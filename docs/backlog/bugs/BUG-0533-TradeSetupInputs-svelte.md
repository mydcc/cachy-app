...
# BUG-0533 — Native number arithmetic used for financial value in TradeSetupInputs.svelte
...
Found in `./src/components/inputs/TradeSetupInputs.svelte` at line 430:
```typescript
