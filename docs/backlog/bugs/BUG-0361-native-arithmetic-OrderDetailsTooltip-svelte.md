...
# BUG-0361 — Native arithmetic usage found in src/components/shared/OrderDetailsTooltip.svelte
...
- **Location**: `src/components/shared/OrderDetailsTooltip.svelte:145`
...
Replace the identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:145` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:145` is replaced with safe decimal arithmetic
