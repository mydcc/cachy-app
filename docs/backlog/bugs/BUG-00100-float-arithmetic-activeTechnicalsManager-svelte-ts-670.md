---
id: BUG-00100
title: Native float arithmetic used for financial values in activeTechnicalsManager.svelte.ts:670
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00100 — Native float arithmetic used for financial values in activeTechnicalsManager.svelte.ts:670
...
File: `src/services/activeTechnicalsManager.svelte.ts`
Line: 670
