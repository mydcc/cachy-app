---
id: BUG-00114
title: Native float arithmetic used for financial values in TakeProfitRow.svelte:94
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00114 — Native float arithmetic used for financial values in TakeProfitRow.svelte:94
...
File: `src/components/shared/TakeProfitRow.svelte`
Line: 94
