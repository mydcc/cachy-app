...
# BUG-0346 — Native arithmetic usage found in src/components/shared/charts/CalendarHeatmap.svelte
...
- **Location**: `src/components/shared/charts/CalendarHeatmap.svelte:305`
...
Replace the identified usage of native arithmetic at `src/components/shared/charts/CalendarHeatmap.svelte:305` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/charts/CalendarHeatmap.svelte:305` is replaced with safe decimal arithmetic
