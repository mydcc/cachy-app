---
id: BUG-00105
title: Native float arithmetic used for financial values in csvService.ts:111
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00105 — Native float arithmetic used for financial values in csvService.ts:111
