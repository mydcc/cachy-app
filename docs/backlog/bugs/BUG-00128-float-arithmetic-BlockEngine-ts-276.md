---
id: BUG-00128
title: Native float arithmetic used for financial values in BlockEngine.ts:276
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00128 — Native float arithmetic used for financial values in BlockEngine.ts:276
...
File: `src/components/shared/backgrounds/engines/BlockEngine.ts`
Line: 276
