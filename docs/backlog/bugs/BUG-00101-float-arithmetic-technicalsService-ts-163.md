---
id: BUG-00101
title: Native float arithmetic used for financial values in technicalsService.ts:163
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00101 — Native float arithmetic used for financial values in technicalsService.ts:163
