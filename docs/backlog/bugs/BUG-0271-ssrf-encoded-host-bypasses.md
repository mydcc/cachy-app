...
AI proxy routes — covered separately in BUG-0256
(`docs/backlog/bugs/BUG-0256-ssrf-ai-proxy-baseurl.md`, part of PR #2194 —
...
- BUG-0256 (`BUG-0256-ssrf-ai-proxy-baseurl.md`, PR #2194) — sibling SSRF
