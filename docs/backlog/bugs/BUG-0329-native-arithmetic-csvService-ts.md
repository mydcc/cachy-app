...
# BUG-0329 — Native arithmetic usage found in src/services/csvService.ts
...
- **Location**: `src/services/csvService.ts:106`
...
Replace the identified usage of native arithmetic at `src/services/csvService.ts:106` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/csvService.ts:106` is replaced with safe decimal arithmetic
