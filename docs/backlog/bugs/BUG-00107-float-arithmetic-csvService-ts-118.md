---
id: BUG-00107
title: Native float arithmetic used for financial values in csvService.ts:118
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00107 — Native float arithmetic used for financial values in csvService.ts:118
