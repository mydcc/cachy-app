---
id: BUG-00122
title: Native float arithmetic used for financial values in TradeFlowBackground.svelte:147
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00122 — Native float arithmetic used for financial values in TradeFlowBackground.svelte:147
