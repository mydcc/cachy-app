---
id: BUG-00123
title: Native float arithmetic used for financial values in TradeFlowBackground.svelte:148
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00123 — Native float arithmetic used for financial values in TradeFlowBackground.svelte:148
...
File: `src/components/shared/backgrounds/TradeFlowBackground.svelte`
Line: 148
