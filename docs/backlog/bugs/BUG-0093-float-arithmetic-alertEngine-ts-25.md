---
id: BUG-0093
title: Native float arithmetic used for financial values in alertEngine.ts:25
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0093 — Native float arithmetic used for financial values in alertEngine.ts:25
