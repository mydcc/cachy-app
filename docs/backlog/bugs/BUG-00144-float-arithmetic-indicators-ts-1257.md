---
id: BUG-00144
title: Native float arithmetic used for financial values in indicators.ts:1257
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00144 — Native float arithmetic used for financial values in indicators.ts:1257
