---
id: BUG-00102
title: Native float arithmetic used for financial values in csvService.ts:95
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00102 — Native float arithmetic used for financial values in csvService.ts:95
