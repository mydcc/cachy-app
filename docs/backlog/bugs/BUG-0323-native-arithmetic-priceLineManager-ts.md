...
# BUG-0323 — Native arithmetic usage found in src/services/chart/priceLineManager.ts
...
- **Location**: `src/services/chart/priceLineManager.ts:311`
...
Replace the identified usage of native arithmetic at `src/services/chart/priceLineManager.ts:311` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/chart/priceLineManager.ts:311` is replaced with safe decimal arithmetic
