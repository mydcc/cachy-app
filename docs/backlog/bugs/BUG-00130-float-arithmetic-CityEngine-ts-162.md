---
id: BUG-00130
title: Native float arithmetic used for financial values in CityEngine.ts:162
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00130 — Native float arithmetic used for financial values in CityEngine.ts:162
...
File: `src/components/shared/backgrounds/engines/CityEngine.ts`
Line: 162
