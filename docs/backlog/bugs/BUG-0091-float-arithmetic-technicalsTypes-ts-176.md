---
id: BUG-0091
title: Native float arithmetic used for financial values in technicalsTypes.ts:176
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0091 — Native float arithmetic used for financial values in technicalsTypes.ts:176
