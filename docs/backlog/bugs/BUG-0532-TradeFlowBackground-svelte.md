...
# BUG-0532 — Native number arithmetic used for financial value in TradeFlowBackground.svelte
...
Found in `./src/components/shared/backgrounds/TradeFlowBackground.svelte` at line 209:
```typescript
