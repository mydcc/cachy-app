---
id: BUG-0097
title: Native float arithmetic used for financial values in uiManager.ts:77
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0097 — Native float arithmetic used for financial values in uiManager.ts:77
