...
# BUG-0360 — Native arithmetic usage found in src/components/shared/OrderDetailsTooltip.svelte
...
- **Location**: `src/components/shared/OrderDetailsTooltip.svelte:137`
...
Replace the identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:137` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:137` is replaced with safe decimal arithmetic
