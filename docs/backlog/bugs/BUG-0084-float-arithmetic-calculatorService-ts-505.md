---
id: BUG-0084
title: Native float arithmetic used for financial values in calculatorService.ts:505
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0084 — Native float arithmetic used for financial values in calculatorService.ts:505
