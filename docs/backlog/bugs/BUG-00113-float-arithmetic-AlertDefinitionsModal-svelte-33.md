---
id: BUG-00113
title: Native float arithmetic used for financial values in AlertDefinitionsModal.svelte:33
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00113 — Native float arithmetic used for financial values in AlertDefinitionsModal.svelte:33
...
File: `src/components/alerts/AlertDefinitionsModal.svelte`
Line: 33
