...
# BUG-0334 — Native arithmetic usage found in src/services/csvService.ts
...
- **Location**: `src/services/csvService.ts:129`
...
Replace the identified usage of native arithmetic at `src/services/csvService.ts:129` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/csvService.ts:129` is replaced with safe decimal arithmetic
