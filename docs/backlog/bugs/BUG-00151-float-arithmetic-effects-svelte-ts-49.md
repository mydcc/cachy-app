---
id: BUG-00151
title: Native float arithmetic used for financial values in effects.svelte.ts:49
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00151 — Native float arithmetic used for financial values in effects.svelte.ts:49
...
File: `src/stores/effects.svelte.ts`
Line: 49
