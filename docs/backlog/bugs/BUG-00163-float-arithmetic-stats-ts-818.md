---
id: BUG-00163
title: Native float arithmetic used for financial values in stats.ts:818
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00163 — Native float arithmetic used for financial values in stats.ts:818
...
File: `src/lib/calculators/stats.ts`
Line: 818
