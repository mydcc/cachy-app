---
id: BUG-0083
title: Native float arithmetic used for financial values in calculatorService.ts:499
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0083 — Native float arithmetic used for financial values in calculatorService.ts:499
