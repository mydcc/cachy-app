...
# BUG-0378 — Native arithmetic usage found in src/lib/calculators/charts.ts
...
- **Location**: `src/lib/calculators/charts.ts:284`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/charts.ts:284` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/charts.ts:284` is replaced with safe decimal arithmetic
