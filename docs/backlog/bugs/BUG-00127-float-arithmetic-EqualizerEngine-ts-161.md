---
id: BUG-00127
title: Native float arithmetic used for financial values in EqualizerEngine.ts:161
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00127 — Native float arithmetic used for financial values in EqualizerEngine.ts:161
...
File: `src/components/shared/backgrounds/engines/EqualizerEngine.ts`
Line: 161
