---
id: BUG-0086
title: Native float arithmetic used for financial values in calculatorService.ts:518
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0086 — Native float arithmetic used for financial values in calculatorService.ts:518
