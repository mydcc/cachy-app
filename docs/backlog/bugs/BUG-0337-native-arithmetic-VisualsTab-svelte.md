...
# BUG-0337 — Native arithmetic usage found in src/components/settings/tabs/VisualsTab.svelte
...
- **Location**: `src/components/settings/tabs/VisualsTab.svelte:78`
...
Replace the identified usage of native arithmetic at `src/components/settings/tabs/VisualsTab.svelte:78` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/settings/tabs/VisualsTab.svelte:78` is replaced with safe decimal arithmetic
