...
# BUG-0359 — Native arithmetic usage found in src/components/shared/OrderDetailsTooltip.svelte
...
- **Location**: `src/components/shared/OrderDetailsTooltip.svelte:131`
...
Replace the identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:131` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/shared/OrderDetailsTooltip.svelte:131` is replaced with safe decimal arithmetic
