---
id: BUG-00133
title: Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:145
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00133 — Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:145
...
File: `src/components/shared/OrderDetailsTooltip.svelte`
Line: 145
