---
id: BUG-00118
title: Native float arithmetic used for financial values in VisualBar.svelte:77
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00118 — Native float arithmetic used for financial values in VisualBar.svelte:77
