---
id: BUG-0089
title: Native float arithmetic used for financial values in technicalsTypes.ts:105
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0089 — Native float arithmetic used for financial values in technicalsTypes.ts:105
