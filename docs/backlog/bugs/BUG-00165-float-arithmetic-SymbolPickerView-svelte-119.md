---
id: BUG-00165
title: Native float arithmetic used for financial values in SymbolPickerView.svelte:119
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00165 — Native float arithmetic used for financial values in SymbolPickerView.svelte:119
