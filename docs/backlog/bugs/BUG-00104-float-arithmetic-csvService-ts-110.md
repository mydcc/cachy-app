---
id: BUG-00104
title: Native float arithmetic used for financial values in csvService.ts:110
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00104 — Native float arithmetic used for financial values in csvService.ts:110
