---
id: BUG-00132
title: Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:137
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00132 — Native float arithmetic used for financial values in OrderDetailsTooltip.svelte:137
