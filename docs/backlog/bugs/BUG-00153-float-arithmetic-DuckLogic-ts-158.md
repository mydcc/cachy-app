---
id: BUG-00153
title: Native float arithmetic used for financial values in DuckLogic.ts:158
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00153 — Native float arithmetic used for financial values in DuckLogic.ts:158
...
File: `src/lib/pets/DuckLogic.ts`
Line: 158
