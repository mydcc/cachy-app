---
id: BUG-00143
title: Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:371
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00143 — Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:371
