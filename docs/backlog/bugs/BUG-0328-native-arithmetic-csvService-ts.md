...
# BUG-0328 — Native arithmetic usage found in src/services/csvService.ts
...
- **Location**: `src/services/csvService.ts:95`
...
Replace the identified usage of native arithmetic at `src/services/csvService.ts:95` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/csvService.ts:95` is replaced with safe decimal arithmetic
