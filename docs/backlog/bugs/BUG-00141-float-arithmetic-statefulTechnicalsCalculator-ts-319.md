---
id: BUG-00141
title: Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:319
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00141 — Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:319
