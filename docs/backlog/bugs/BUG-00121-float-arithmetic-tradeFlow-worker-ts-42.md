---
id: BUG-00121
title: Native float arithmetic used for financial values in tradeFlow.worker.ts:42
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00121 — Native float arithmetic used for financial values in tradeFlow.worker.ts:42
...
File: `src/components/shared/backgrounds/tradeFlow.worker.ts`
Line: 42
