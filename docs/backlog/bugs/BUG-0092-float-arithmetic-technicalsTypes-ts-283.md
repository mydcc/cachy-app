---
id: BUG-0092
title: Native float arithmetic used for financial values in technicalsTypes.ts:283
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0092 — Native float arithmetic used for financial values in technicalsTypes.ts:283
