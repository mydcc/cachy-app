...
# BUG-0382 — Native arithmetic usage found in src/lib/calculators/charts.ts
...
- **Location**: `src/lib/calculators/charts.ts:433`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/charts.ts:433` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/charts.ts:433` is replaced with safe decimal arithmetic
