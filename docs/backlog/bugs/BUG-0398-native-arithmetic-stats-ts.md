...
# BUG-0398 — Native arithmetic usage found in src/lib/calculators/stats.ts
...
- **Location**: `src/lib/calculators/stats.ts:734`
...
Replace the identified usage of native arithmetic at `src/lib/calculators/stats.ts:734` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/lib/calculators/stats.ts:734` is replaced with safe decimal arithmetic
