---
id: BUG-0112
title: Native float arithmetic used for financial values in ConnectionsTab.svelte:74
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0112 — Native float arithmetic used for financial values in ConnectionsTab.svelte:74
...
File: `src/components/settings/tabs/ConnectionsTab.svelte`
Line: 74
