---
id: BUG-00116
title: Native float arithmetic used for financial values in VisualBar.svelte:48
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00116 — Native float arithmetic used for financial values in VisualBar.svelte:48
