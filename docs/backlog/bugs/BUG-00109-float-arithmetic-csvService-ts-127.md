---
id: BUG-00109
title: Native float arithmetic used for financial values in csvService.ts:127
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00109 — Native float arithmetic used for financial values in csvService.ts:127
