---
id: BUG-0331
title: Native arithmetic usage found in src/services/csvService.ts
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0331 — Native arithmetic usage found in src/services/csvService.ts
...
- **Location**: `src/services/csvService.ts:111`
...
Replace the identified usage of native arithmetic at `src/services/csvService.ts:111` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/csvService.ts:111` is replaced with safe decimal arithmetic
