...
# BUG-0366 — Native arithmetic usage found in src/components/inputs/TradeSetupInputs.svelte
...
- **Location**: `src/components/inputs/TradeSetupInputs.svelte:608`
...
Replace the identified usage of native arithmetic at `src/components/inputs/TradeSetupInputs.svelte:608` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/components/inputs/TradeSetupInputs.svelte:608` is replaced with safe decimal arithmetic
