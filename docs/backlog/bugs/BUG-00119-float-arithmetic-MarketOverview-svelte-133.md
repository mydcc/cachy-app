---
id: BUG-00119
title: Native float arithmetic used for financial values in MarketOverview.svelte:133
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00119 — Native float arithmetic used for financial values in MarketOverview.svelte:133
