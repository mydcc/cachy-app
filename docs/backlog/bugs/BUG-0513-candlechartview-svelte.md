---
id: BUG-0513
title: Native number arithmetic on financial value in CandleChartView.svelte
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0513 — Native number arithmetic on financial value in CandleChartView.svelte
