---
id: BUG-00103
title: Native float arithmetic used for financial values in csvService.ts:109
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00103 — Native float arithmetic used for financial values in csvService.ts:109
