---
id: BUG-00168
title: Native float arithmetic used for financial values in SymbolPickerView.svelte:126
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00168 — Native float arithmetic used for financial values in SymbolPickerView.svelte:126
