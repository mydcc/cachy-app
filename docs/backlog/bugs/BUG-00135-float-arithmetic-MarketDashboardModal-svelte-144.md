---
id: BUG-00135
title: Native float arithmetic used for financial values in MarketDashboardModal.svelte:144
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00135 — Native float arithmetic used for financial values in MarketDashboardModal.svelte:144
...
File: `src/components/shared/MarketDashboardModal.svelte`
Line: 144
