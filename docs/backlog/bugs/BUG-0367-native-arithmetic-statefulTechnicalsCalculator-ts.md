...
# BUG-0367 — Native arithmetic usage found in src/utils/statefulTechnicalsCalculator.ts
...
- **Location**: `src/utils/statefulTechnicalsCalculator.ts:77`
...
Replace the identified usage of native arithmetic at `src/utils/statefulTechnicalsCalculator.ts:77` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/utils/statefulTechnicalsCalculator.ts:77` is replaced with safe decimal arithmetic
