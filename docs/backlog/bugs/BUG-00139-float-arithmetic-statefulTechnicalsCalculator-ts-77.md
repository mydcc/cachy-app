---
id: BUG-00139
title: Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:77
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00139 — Native float arithmetic used for financial values in statefulTechnicalsCalculator.ts:77
