...
# BUG-0402 — A migrated rule keeps the old price after its alert is edited
...
- [`FEAT-0399`](../features/FEAT-0401-record-migration-origin-ledger.md) — the ledger a fix needs
