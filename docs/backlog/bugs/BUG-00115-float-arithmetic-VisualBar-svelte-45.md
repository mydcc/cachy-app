---
id: BUG-00115
title: Native float arithmetic used for financial values in VisualBar.svelte:45
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00115 — Native float arithmetic used for financial values in VisualBar.svelte:45
