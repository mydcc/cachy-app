---
id: BUG-0479
title: Native number arithmetic on financial value in marketDashboard.ts
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0479 — Native number arithmetic on financial value in marketDashboard.ts
...
File: `src/lib/marketDashboard.ts`
Line: 105
