---
id: BUG-00147
title: Native float arithmetic used for financial values in divergenceScanner.ts:37
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00147 — Native float arithmetic used for financial values in divergenceScanner.ts:37
