---
id: BUG-0098
title: Native float arithmetic used for financial values in syncService.ts:251
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0098 — Native float arithmetic used for financial values in syncService.ts:251
