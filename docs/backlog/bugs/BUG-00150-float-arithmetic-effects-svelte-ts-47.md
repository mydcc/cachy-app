---
id: BUG-00150
title: Native float arithmetic used for financial values in effects.svelte.ts:47
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00150 — Native float arithmetic used for financial values in effects.svelte.ts:47
