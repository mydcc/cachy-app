...
# BUG-0330 — Native arithmetic usage found in src/services/csvService.ts
...
- **Location**: `src/services/csvService.ts:110`
...
Replace the identified usage of native arithmetic at `src/services/csvService.ts:110` with safe decimal arithmetic (e.g. `Decimal`, `rust_decimal`).

## Acceptance criteria

- [ ] The identified usage of native arithmetic at `src/services/csvService.ts:110` is replaced with safe decimal arithmetic
