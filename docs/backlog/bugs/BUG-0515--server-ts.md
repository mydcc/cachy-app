---
id: BUG-0515
title: Native number arithmetic on financial value in +server.ts
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0515 — Native number arithmetic on financial value in +server.ts
...
File: `src/routes/api/leverage-margin-mode/+server.ts`
Line: 132
