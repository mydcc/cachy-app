---
id: BUG-00110
title: Native float arithmetic used for financial values in csvService.ts:128
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00110 — Native float arithmetic used for financial values in csvService.ts:128
