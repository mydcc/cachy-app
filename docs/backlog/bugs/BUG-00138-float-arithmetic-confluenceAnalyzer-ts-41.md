---
id: BUG-00138
title: Native float arithmetic used for financial values in confluenceAnalyzer.ts:41
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00138 — Native float arithmetic used for financial values in confluenceAnalyzer.ts:41
...
File: `src/utils/confluenceAnalyzer.ts`
Line: 41
