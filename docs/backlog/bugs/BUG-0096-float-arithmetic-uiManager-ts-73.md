---
id: BUG-0096
title: Native float arithmetic used for financial values in uiManager.ts:73
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-0096 — Native float arithmetic used for financial values in uiManager.ts:73
...
File: `src/services/uiManager.ts`
Line: 73
