---
id: BUG-00136
title: Native float arithmetic used for financial values in TradeSetupInputs.svelte:362
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00136 — Native float arithmetic used for financial values in TradeSetupInputs.svelte:362
