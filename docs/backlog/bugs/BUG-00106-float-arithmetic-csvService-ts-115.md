---
id: BUG-00106
title: Native float arithmetic used for financial values in csvService.ts:115
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00106 — Native float arithmetic used for financial values in csvService.ts:115
