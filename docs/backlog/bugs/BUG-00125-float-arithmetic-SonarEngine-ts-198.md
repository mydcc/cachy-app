---
id: BUG-00125
title: Native float arithmetic used for financial values in SonarEngine.ts:198
type: bug
status: specced
priority: P1
milestone: none
...
# BUG-00125 — Native float arithmetic used for financial values in SonarEngine.ts:198
...
File: `src/components/shared/backgrounds/engines/SonarEngine.ts`
Line: 198
