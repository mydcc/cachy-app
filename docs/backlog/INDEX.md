...
Counts by status: 💡 idea 29 · 📋 specced 26 · 🟢 ready 1 · 🟡 in-progress 3 · ✅ done 279 · ⛔ dropped 1
...
| [BUG-0457](bugs/BUG-0457-chart-header-values-ignore-source.md) | Chart pane headers recompute sourced indicators over the close on every live tick | P2 | 📋 specced | chart |
...
| [BUG-0457](bugs/BUG-0457-chart-header-values-ignore-source.md) | Chart pane headers recompute sourced indicators over the close on every live tick | P2 | 📋 specced | none | community, pro, private | none | none | — |
