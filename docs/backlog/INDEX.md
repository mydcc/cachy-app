...
Counts by status: 💡 idea 27 · 📋 specced 21 · 🟡 in-progress 2 · ✅ done 307 · ⛔ dropped 1
...
| [BUG-0474](bugs/BUG-0474-ai-actions-executed-without-schema-validation.md) | Parsed AI actions are executed without schema validation | P2 | 🟡 in-progress | security |
...
| [BUG-0474](bugs/BUG-0474-ai-actions-executed-without-schema-validation.md) | Parsed AI actions are executed without schema validation | P2 | 🟡 in-progress | none | community, pro, private | A | none | — |
