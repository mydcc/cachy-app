...
# FEAT-0399 — Record a migration origin ledger for rules converted from legacy alerts
...
- Threshold drift between an alert and its already-migrated rule. The migration
  ...
  leaves the rule at the old level. Tracked as [`BUG-0400`](../bugs/BUG-0400-migrated-rule-keeps-stale-threshold.md) — it is a correctness bug in
