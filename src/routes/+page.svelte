    ...
    {#if $settingsStore.showSidebars}
        ...
        <div class="hidden xl:flex absolute -right-60 top-8 w-52 flex-col gap-3 transition-all duration-300">
            ...
            {#if $settingsStore.showTechnicals}
                <div class="absolute top-0 left-full ml-8 transition-all duration-300 transform origin-left z-40"
...
<footer class="relative z-10 w-full max-w-4xl mx-auto text-center py-4 text-sm text-[var(--text-secondary)] flex justify-center items-center gap-4">
