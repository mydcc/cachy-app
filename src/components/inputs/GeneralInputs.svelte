...
<script lang="ts">
  ...
  let isLeverageSynced = $derived(
    remoteLev !== undefined && leverage !== null && new Decimal(leverage).equals(remoteLev),
  );
  ...
  let isFeeSynced = $derived(
    targetRemoteFee !== undefined && fees !== null && new Decimal(fees).equals(targetRemoteFee),
  );
        ...
        {#if remoteLev !== undefined}
          <button
            ...
            title={isLeverageSynced
              ...
              : $_("dashboard.generalInputs.manualOverride", { values: { value: remoteLev + "x" } })}
      ...
      <div class="relative">
        ...
        {#if targetRemoteFee !== undefined}
          <button
            ...
            title={isFeeSynced
              ? $_("dashboard.generalInputs.syncedWithApi")
              : $_("dashboard.generalInputs.manualOverride", { values: { value: targetRemoteFee + "%" } })}
            onclick={syncFee}
          ></button>
        {/if}
      </div>
