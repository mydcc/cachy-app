...
<!--
  FEAT-0389 -- placeholder for the price condition builder, which is FEAT-0390.
  ...
  is exercised now, and FEAT-0390 replaces the body of this
...
<div class="pending" role="status">
    ...
    <p>{$_("dashboard.alerts.panel.pendingBody", { values: { item: "FEAT-0390" } })}</p>
</div>
