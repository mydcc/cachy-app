...
<!--
  FEAT-0389 -- placeholder for the condition combiner builder, which is FEAT-0030.
  ...
  is exercised now, and FEAT-0030 replaces the body of this
...
<div class="pending" role="status">
    ...
    <p>{$_("dashboard.alerts.panel.pendingBody", { values: { item: "FEAT-0030" } })}</p>
</div>
