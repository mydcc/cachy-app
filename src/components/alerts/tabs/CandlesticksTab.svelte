...
<!--
  FEAT-0389 -- placeholder for the candlestick pattern builder, which is FEAT-0394.
  ...
  is exercised now, and FEAT-0394 replaces the body of this
...
<div class="pending" role="status">
    ...
    <p>{$_("dashboard.alerts.panel.pendingBody", { values: { item: "FEAT-0394" } })}</p>
</div>
