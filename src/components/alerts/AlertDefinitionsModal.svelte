...
<ModalFrame title={$t('dashboard.alerts.title', { default: 'Alerts' })} onclose={onClose}>
    <div class="alert-form">
        ...
        <div class="input-group">
            <input type="text" bind:value={newAlertSymbol} placeholder="Symbol (e.g. BTCUSDT)" class="form-input" />
            <input type="number" bind:value={newAlertPrice} placeholder="Target Price" class="form-input" />
