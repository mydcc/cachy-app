<script lang="ts">
    ...
    function handleRealTimeUpdate(newKline: any) {
        ...
        const close = newKline.close
            ? new Decimal(newKline.close)
            : new Decimal(0);
    ...
    >
            ...
            {#if showTimeframePopup}
                ...
                >
                    <div class="grid grid-cols-3 gap-2">
                        <button
                            class="py-2 border border-[var(--border-color)] hover:bg-[var(--accent-color)] hover:text-[var(--btn-accent-text)] rounded text-sm font-medium text-white"
                    ...
                    <div class="flex gap-1 mt-1">
                        ...
                        />
                        <button
                            class="px-3 bg-[var(--bg-tertiary)] hover:bg-[var(--accent-color)] hover:text-[var(--btn-accent-text)] rounded text-sm font-medium text-white"
        ...
        {:else if data}
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    class="text-xs grid grid-cols-[1fr_auto_auto] gap-x-4 gap-y-1"
                >
                    {#each data.oscillators as osc}
                        ...
                        <span
                            class="text-right text-[var(--text-secondary)] font-mono"
            ...
            >
                ...
                <div class="text-xs grid grid-cols-[auto_1fr] gap-x-4 gap-y-1">
                    {#each Object.entries(data.pivots.classic).sort( (a, b) => b[1]
                        ...
                        >
                        <span
                            class="text-right text-[var(--text-primary)] font-mono"
                            >{formatVal(val)}</span
                        >
                    {/each}
                </div>
