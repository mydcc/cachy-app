<script lang="ts">
  ...
  onMount(() => {
    ...
    const material = new THREE.ShaderMaterial({
        ...
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(settingsState.galaxySettings.camPos ? 0xffaa00 : 0xffaa00) }, // Default fallback
    ...
    const animate = () => {
        ...
        if (settingsState.burningBordersIntensity === "low") baseIntensity = 0.5;
        if (settingsState.burningBordersIntensity === "high") baseIntensity = 2.0;
