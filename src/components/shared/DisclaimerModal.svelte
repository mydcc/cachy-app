...
{#if visible}
    ...
    >
        <!-- Header -->
        <div class="p-4 border-b border-[var(--border-primary)] flex items-center gap-3 bg-[var(--bg-tertiary)] rounded-t-xl">
             <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[var(--warning-color)] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Content -->
        <div class="p-4 overflow-y-auto text-sm leading-relaxed text-[var(--text-secondary)] space-y-3">
            {@html $_('legal.disclaimerBody')}
        </div>

        <!-- Footer -->
        <div class="p-4 border-t border-[var(--border-primary)] bg-[var(--bg-tertiary)] rounded-b-xl flex justify-end">
            <button
