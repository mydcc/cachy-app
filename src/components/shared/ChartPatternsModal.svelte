                ...
                <div class="flex flex-col lg:flex-row gap-6 h-full">
                    ...
                    <div class="w-full lg:w-2/3 flex flex-col gap-6">
                        ...
                        <div class="bg-[var(--bg-tertiary)] p-4 rounded-xl border border-[var(--border-color)] flex-grow">
                            ...
                            <div class="prose dark:prose-invert text-sm max-w-none">
                                {@html renderMarkdown(getLocalizedText(currentPattern, 'description'))}
                            </div>

                            <!-- Characteristics -->
                            <h3 class="text-sm font-bold uppercase text-[var(--text-secondary)] mt-4 mb-2">Characteristics</h3>
                            <ul class="list-disc list-inside text-sm text-[var(--text-primary)]">
                    ...
                    <div class="w-full lg:w-1/3 flex flex-col gap-6 h-full">
                         ...
                         <div class="bg-[var(--bg-tertiary)] p-4 rounded-xl border border-[var(--border-color)]">
                            ...
                            <div class="prose dark:prose-invert text-sm max-w-none">
                                {@html renderMarkdown(getLocalizedText(currentPattern, 'trading'))}
                            </div>
                        </div>
                        ...
                        <div class="bg-[var(--bg-tertiary)] p-4 rounded-xl border border-[var(--border-color)] flex-grow">
                            ...
                            <div class="prose dark:prose-invert text-sm max-w-none">
                                {@html renderMarkdown(getLocalizedText(currentPattern, 'advancedConsiderations'))}
                            </div>

                            <h3 class="text-sm font-bold uppercase text-[var(--text-secondary)] mt-4 mb-2">Performance</h3>
                            <div class="prose dark:prose-invert text-sm max-w-none">
                                {@html renderMarkdown(getLocalizedText(currentPattern, 'performanceStats'))}
                            </div>
                        </div>
                    </div>
                </div>
