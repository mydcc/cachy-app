...
<ModalFrame
  title={$_("modals.addToPosition.title")}
  {onclose}
  isOpen={true}
  width={440}
  height={335}
  ...
  <div class="flex flex-col gap-4 p-4 min-w-[300px]">
    <div class="text-sm text-[var(--text-secondary)]">
      ...
      {#if position?.priceStale || position?.unpriced}
        <!--
          Same disclosure as the close dialog: the preview below prices off
          the resolved mark, which may be a substitute, stale, or recovered
