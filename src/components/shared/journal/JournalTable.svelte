...
<script lang="ts">
    ...
    function addTag(tradeId: number | string, tag: string, currentTags: string[] = []) {
    ...
    let tagInputValues: Record<number | string, string> = $state({});
    ...
    function triggerFileUpload(id: number | string) {
        (
