<script lang="ts">
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          ...
          dirData.shortPnl >= 0 ? themeColors.success : themeColors.danger,
        ],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          themeColors.accent,
          costData.net >= 0 ? themeColors.success : themeColors.danger,
        ],
      },
    ],
  };
  ...
  $: totalPages = Math.ceil(
    (groupBySymbol ? groupedTrades.length : sortedTrades.length) / itemsPerPage
  );
      ...
      {#if activePreset === "performance"}
        ...
        >
          <LineChart
            ...
            description={$_("journal.deepDive.charts.descriptions.equityCurve")}
          />
        </div>
        <div
          class="chart-tile bg-[var(--bg-secondary)] p-4 rounded-lg border border-[var(--border-color)] h-[250px]"
        ...
        >
          <BarChart
            ...
            description={$_("journal.deepDive.charts.descriptions.monthlyPnl")}
          />
        </div>
      {:else if activePreset === "quality"}
        ...
        >
          <LineChart
            ...
            yLabel="R"
            description={$_("journal.deepDive.charts.descriptions.cumulativeR")}
          />
        </div>
      {:else if activePreset === "direction"}
        ...
        >
          <BarChart
            ...
            horizontal={true}
            description={$_("journal.deepDive.charts.descriptions.topSymbols")}
          />
        </div>
        <div
          class="chart-tile bg-[var(--bg-secondary)] p-4 rounded-lg border border-[var(--border-color)] h-[250px]"
        ...
        >
          <BarChart
            ...
            description={$_("journal.deepDive.charts.descriptions.longVsShort")}
          />
        </div>
      ...
      {:else if activePreset === "costs"}
        ...
        >
          <BarChart
            ...
            description={$_("journal.deepDive.charts.descriptions.grossVsNet")}
          />
        </div>
        <div
          class="chart-tile bg-[var(--bg-secondary)] p-4 rounded-lg border border-[var(--border-color)] h-[250px]"
          ...
          <div class="grid grid-cols-2 gap-x-4">
            ...
            >
              <input
                ...
                class="form-checkbox h-4 w-4 text-[var(--accent-color)] rounded focus:ring-0"
              />
              <span class="text-sm">{$_("journal.table.action")}</span>
            </label>
          </div>
        </div>
      {/if}
          ...
          <tbody>
            {#each paginatedTrades as group}
              ...
              >
                ...
                <td class="text-right p-3"
                  >{(group.totalTrades > 0
                    ? (group.wonTrades / group.totalTrades) * 100
                    : 0
                  ).toFixed(1)}%</td
                >
                <td
                  class="text-right p-3 {group.totalProfitLoss.gt(0)
                    ? 'text-[var(--success-color)]'
                    : 'text-[var(--danger-color)]'}"
                >
          ...
          <tbody>
            {#each paginatedTrades as trade}
              ...
              <tr>
                {#if columnVisibility.date}
                  <td
                    >{tradeDate.getFullYear() > 1970
                      ? tradeDate.toLocaleString($locale || undefined, {
                          day: "2-digit",
                          month: "2-digit",
                          year: "2-digit",
                          hour: "2-digit",
                ...
                {#if columnVisibility.type}
                  <td
                    class={trade.tradeType.toLowerCase() === "long"
                      ? "text-[var(--success-color)]"
                      : "text-[var(--danger-color)]"}
                  ...
                  <td>
                    ...
                    {:else}
                      <select
                        ...
                        data-id={trade.id}
                        on:change={(e) => handleStatusChange(trade.id, e)}
                      >
                        <option value="Open" selected={trade.status === "Open"}
                          >{$_("journal.filterOpen")}</option
                        >
                        <option value="Won" selected={trade.status === "Won"}
                          >{$_("journal.filterWon")}</option
                        >
                        <option value="Lost" selected={trade.status === "Lost"}
                          >{$_("journal.filterLost")}</option
                        >
                      </select>
                    {/if}
                  </td>
                  ...
                  >
                      ...
                      >
                        ...
                        >
                          ...
                          <label
                            ...
                            title={$_("journal.labels.replaceScreenshot")}
                          >
                            <input
                              ...
                              class="hidden"
                              on:change={(e) =>
                                handleScreenshotUpload(trade.id, e)}
                              on:click|stopPropagation
                            />
                            <!-- svelte-ignore svelte/no-at-html-tags -->
                            {@html icons.refresh || "🔄"}
                          ...
                          <button
                            ...
                            title={$_("journal.labels.deleteScreenshot")}
                            on:click|stopPropagation={() =>
                              deleteScreenshot(trade.id)}
                          >
                            <!-- svelte-ignore svelte/no-at-html-tags -->
                            {@html icons.delete || "🗑️"}
                          </button>
                    ...
                    {:else}
                      <label
                        ...
                        title={$_("journal.labels.uploadScreenshot")}
                      >
                        <!-- svelte-ignore svelte/no-at-html-tags -->
                        <span class="text-[var(--accent-color)]"
                          >{@html icons.plus || "+"}</span
                        >
                        <input
                          ...
                          accept="image/*"
                          class="hidden"
                          on:change={(e) => handleScreenshotUpload(trade.id, e)}
                        />
                      </label>
                    {/if}
                  </td>
                  ...
                  <td>
                    <JournalEntryTags
                      ...
                      onTagsChange={(newTags) =>
                        handleTagsUpdate(trade.id, newTags)}
                    />
                  </td>
                {/if}
                ...
                {#if columnVisibility.notes}
                  <td class="notes-cell">
                    <input
                      ...
                      value={trade.notes || ""}
                      on:change={(e) =>
                        handleNotesUpdate(trade.id, e.currentTarget.value)}
                    />
                  </td>
                {/if}
                {#if columnVisibility.action}
                  <td class="text-center"
                    ><button
                      ...
                      on:click={() => confirmDeleteTrade(trade.id)}
                    >
                      <!-- svelte-ignore svelte/no-at-html-tags -->
            ...
            {#if paginatedTrades.length === 0}
              <tr
                ><td
                  colspan={Object.values(columnVisibility).filter(Boolean)
                    .length + 1}
          ...
          >
            {#if rollingWinRateData}
              <div class="mb-4 h-64">
                <LineChart
                  ...
                  title={$_("journal.deepDive.charts.labels.rollingWinRate")}
                  yLabel="%"
                  description={$_(
            ...
            {#if rollingPFData}
              <div class="h-64 mb-4">
                <LineChart
                  data={rollingPFData}
                  title={$_("journal.deepDive.charts.labels.rollingPF")}
                  yLabel="PF"
                  description={$_(
            ...
            {#if rollingSQNData}
              <div class="h-64">
                <LineChart
                  data={rollingSQNData}
                  title={$_("journal.deepDive.charts.labels.rollingSQN")}
                  yLabel="SQN"
                  description={$_(
        ...
        {:else if activeDeepDivePreset === "timing"}
          ...
          >
            <BarChart
              ...
              title={$_("journal.deepDive.charts.labels.durationAnalysis")}
              description={$_(
          ...
          >
              ...
              {#each confluenceData as row}
                ...
                {#each row.hours as cell}
                  ...
                  >
                    {#if cell.count > 0}
                      <span
                        class="text-[9px] font-mono {Math.abs(cell.pnl) > 50
            ...
            <div class="text-xs text-[var(--text-secondary)] mt-1">
              {$_("journal.deepDive.charts.descriptions.confluenceMatrix")}
            </div>
          </div>
