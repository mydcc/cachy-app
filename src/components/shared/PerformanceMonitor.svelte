...
<div class="performance-monitor">
    <div class="monitor-header">
        <h3>{$_("performance.monitor") || "Performance Monitor"}</h3>
        <div class="last-update">
            {$_("performance.lastUpdate") || "Last update"}:
    ...
    <div class="metrics-grid">
        ...
        <div class="metric-card">
            <div class="metric-header">
                ...
                <span class="metric-label">{$_("performance.apiCalls")}</span>
            </div>
            <div
                class="metric-value {getColor(
        ...
        <div class="metric-card">
            <div class="metric-header">
                ...
                <span class="metric-label">{$_("performance.cacheHit")}</span>
            </div>
            <div
                class="metric-value {getColor(
        ...
        <div class="metric-card">
            <div class="metric-header">
                ...
                <span class="metric-label">{$_("performance.latency")}</span>
            </div>
            <div
                class="metric-value {getColor(
        ...
        <div class="metric-card">
            <div class="metric-header">
                ...
                <span class="metric-label">{$_("performance.network")}</span>
            </div>
    ...
    <div class="performance-tips">
        <h4>
            {$_("performance.tips") || "Optimization Tips"}
        </h4>
        <div class="tips-list">
