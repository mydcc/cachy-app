...
<script lang="ts">
    ...
    let activeSubTab = $derived(uiState.settingsWorkspaceTab);
    function setSubTab(tab: string) {
        uiState.settingsWorkspaceTab = tab;
    }
</script>
...
>
    ...
    <div class="subtab-nav">
        <button
            class:active={activeSubTab === "sidebar"}
            onclick={() => setSubTab("sidebar")}
        >
            {$_("settings.profile.workspace.subtabs.sidebar") || "Sidebar"}
        </button>
        <button
            class:active={activeSubTab === "market"}
            onclick={() => setSubTab("market")}
        >
            {$_("settings.profile.workspace.subtabs.market") || "Markt"}
        </button>
        <button
            class:active={activeSubTab === "system"}
            onclick={() => setSubTab("system")}
        >
            {$_("settings.profile.workspace.subtabs.system") || "System"}
        </button>
    </div>

    <div class="subtab-content">
        {#if activeSubTab === "sidebar"}
        ...
        {:else if activeSubTab === "market"}
            ...
            <section class="settings-section">
                <h3 class="section-title">
                    {$_("settings.workspace.marketOverview") ||
                        "Market Overview"}
                </h3>
                <div
                            ...
                            <div class="field-group justify-end h-full">
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        bind:checked={
                                            settingsState.autoFetchBalance
                                        }
        ...
        {:else if activeSubTab === "system"}
            ...
            <section class="settings-section">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="section-title mb-0">
                        {$_("settings.workspace.panelTitle") ||
                            "Side Panel & Widgets"}
                    </h3>
                    <button
                        ...
                        {#if settingsState.sidePanelMode === "chat"}
                            <div class="field-group">
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    bind:value={
                                        settingsState.minChatProfitFactor
                                    }
                                    use:enhancedInput
                                    class="input-field"
                                />
            ...
            >
                <h3 class="section-title">
                    {$_("settings.workspace.performanceTitle") ||
                        "Performance & Data"}
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="field-group">
...
<style>
    ...
    .subtab-nav button.active::after {
        content: "";
        position: absolute;
        bottom: -1px;
        left: 0;
