                    ...
                    >
                        ...
                        {#if rsiSettings.showSignal}
                            <div class="grid grid-cols-2 gap-x-4 gap-y-2">
                                <div class="flex items-center justify-between">
                                    <label for="rsi-signal-type" class="text-xs"
                                        >Type</label
                                    >
                                    <select
                                        id="rsi-signal-type"
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <input
                                ...
                                class="input-field rounded settings-number-input text-xs"
                                disabled={!isPro ||
                                    emaSettings.ema1.smoothingType === "none"}
                                use:enhancedInput={{
                                    min: 1,
                                    max: 100,
                                }}
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <input
                                ...
                                class="input-field rounded settings-number-input text-xs"
                                disabled={!isPro ||
                                    emaSettings.ema2.smoothingType === "none"}
                                use:enhancedInput={{
                                    min: 1,
                                    max: 100,
                                }}
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <input
                                ...
                                class="input-field rounded settings-number-input text-xs"
                                disabled={!isPro ||
                                    emaSettings.ema3.smoothingType === "none"}
                                use:enhancedInput={{
                                    min: 1,
                                    max: 100,
                                }}
