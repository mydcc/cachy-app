...
<div class="flex flex-col gap-4" role="tabpanel" id="tab-ai">
    ...
    >
        ...
        >
            ...
            >
                ...
                <p class="text-[10px] text-[var(--text-secondary)] italic">
                    Use <code>gemini-1.5-flash</code> for stability if the experimental
                    version fails.
                </p>
            </div>
            <div
        ...
        >
            Your API keys are stored locally in your browser and are never saved
            to our servers. They are only used to communicate directly with the
            AI providers.
        </p>
    </div>
</div>
