...
const defaultSettings: IndicatorSettings = {
  ...
  ema: {
    ema1: { length: 9, offset: 0, smoothingType: "ema", smoothingLength: 0 },
    ema2: { length: 20, offset: 0, smoothingType: "ema", smoothingLength: 0 },
    ema3: { length: 50, offset: 0, smoothingType: "ema", smoothingLength: 0 },
    source: "close",
  },
  sma: {
    sma1: { length: 20 },
