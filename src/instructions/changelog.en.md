...
- **Release:** Official Release Candidate.
- **New:** **Advanced Order Management**: Full integration of Bitunix Trigger Orders for Take Profit and Stop Loss handling via specialized backend proxy.
- **New:** **Chat System V2**: Enhanced backend infrastructure for global chat and private notes.
- **Architecture:** Finalized "Safe Swap" synchronization logic for robust position tracking.
- **System:** Production-grade security improvements and stability fixes.
...
- **New:** **Chat / Side Panel**: Collapsible side panel for private notes or global chat.
