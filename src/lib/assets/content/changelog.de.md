...
> Commit-Nachrichten erzeugt und in `CHANGELOG.md` im Repository sowie unter
> [GitHub Releases](https://github.com/mydcc/cachy-app/releases) veröffentlicht.
> Die folgende Liste ist die von Hand gepflegte Historie der 0.9x-Versionen.
