    ...
    describe('getPerformanceData', () => {
        ...
        it('should calculate equity curve correctly for manual trades', () => {
            const trades = [
                ...
                createTrade({ date: '2023-01-02T10:00:00Z', status: 'Lost', riskAmount: new Decimal(50), totalNetProfit: new Decimal(-50) })
            ];
        ...
        it('should calculate drawdown correctly', () => {
            const trades = [
                ...
                createTrade({ date: '2023-01-02', status: 'Lost', riskAmount: new Decimal(50), totalNetProfit: new Decimal(-50) }),    // Peak 100, Curr 50 -> DD -50
                createTrade({ date: '2023-01-03', status: 'Lost', riskAmount: new Decimal(20), totalNetProfit: new Decimal(-20) }),    // Peak 100, Curr 30 -> DD -70
    ...
    describe('getQualityData', () => {
        it('should handle R-Multiples correctly', () => {
             const trades = [
                ...
                createTrade({ status: 'Lost', riskAmount: new Decimal(50), totalNetProfit: new Decimal(-50) }) // -1R
            ];
